...
const CHAPTER_DATA = [
    ...
    // 3.3 高校落地模式方案
    {
        ...
        tableRows: [
            ...
            { 
                dim: "建设周期", 
                light: "预估3 - 4 周 (SaaS 快速部署)", 
                heavy: "预估3 - 4 个月 (课程联合研发)" 
            },
            // { 
            //     dim: "预估投入", 
            //     light: "¥5万 / 年 (服务费)", 
            ...
            { 
                ...
                heavy: "<span class='highlight-green'>非学历教育创收，长效资产沉淀</span>" 
            },
            { 
                dim: "典型院校", 
                light: "已开设预科基地校", 
    ...
    //             type: "blue", 
    //             title: "问题", 
    //             desc: "学校会为曝光率或分成录制csca备考辅导课吗?<br>换一种说法是：纽约大学会为了SAT考试录制课程放在第三方平台吗？如果学生考了高分，转身就去了哥伦比亚大学怎么办？",
    //             link: "" // 这里填链接，不填则传空字符串 ""
    //         },
    //         { 
    //             type: "blue", 
    ...
    //             type: "blue", 
    //             title: "问题", 
    //             desc: "如果把课程预科化，是不是就能解决上面的问题？<br>高校的动力变成非学历收入和提前锁定学生，平台的价值也从“应试辅导”升维至“录取通道”，学生购买的也不再是课件，而是高校认可的学术档案与直通门票？",
    //             link: "" // 这里填链接，不填则传空字符串 ""
    //         },
    //     ],
    // },
